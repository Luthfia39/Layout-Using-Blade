...
<body style="background-color: #F0C5C0;">
    ...
    @if (Auth::check() && Auth::user()->level == 'admin')
        <nav class="navbar navbar-expand-md shadow-sm sticky-top top-0" style="background-color: #BF9D99;">
            <div class="container">
                <a class="navbar-brand fw-bold" href="{{ url('/buku') }}">
                ...
                <div class="collapse navbar-collapse fw-bold" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('index') }}">Buku</a>
                        </li>
                        <li class="nav-item">
